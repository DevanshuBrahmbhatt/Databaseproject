 ...
 <div class="container">
  ...
  <div class="form">
	...
	<div class="row">
	  ...
	  <form   action="Faculty_ContactAction.php" method="POST"  class="col s12">
		...
		<div class="z-depth-2 #fafafa grey lighten-5"> 
			...
			<div class="container">  
			   ...
			   <div class="container-fluid">
					 <h3  id="heading"  align="center" style="color:#e85a50"> <U>Contact Faculty</U> </h3>
				</div>
    	...
    	<select  name="f_id[]" class="select"  id="faculty"  multiple>
     ...
     <!--     <textarea  class="materialize-textarea" name="message"  id="textarea1" ></textarea>-->
          ...
          <input  placeholder="Short Message"   name="message" type="text" id="message"  required>
           </div>
