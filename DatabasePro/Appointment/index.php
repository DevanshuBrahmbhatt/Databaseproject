...
<!--		<div class="input-field col s6">
	  ...
	  <form   action="Appoinment_action.php" method="POST">

		<div class="z-depth-2"> 
		
		
		  <div class="container-fluid">
					 <h4  id="heading"  align="center" style="color:#54457F">   Welcome <?php echo" " . $_SESSION['collegeId'] . " " ; ?>  Take Your Appoinment
 </h4>
				</div>
    	...
    	<select  name="purpose" class="select"  id="purpose" >
    		<option value="" disabled selected>Choose your Purpose</option>
			<option value="Doubt for subject">Doubt for subject</option>
     ...
     <!--     <textarea  class="materialize-textarea" name="message"  id="textarea1" ></textarea>-->
          ...
          <input  placeholder="Anything Important You Want to mention"   name="message" type="text" id="message"  required>
           </div>
